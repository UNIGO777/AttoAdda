...
const Sidebar = () => {
  ...
  return (
    <motion.div
      className="bg-white shadow-xl h-screen relative z-10"
    ...
    >
      ...
      <div className="p-6 border-b border-gray-100">
        <div className="flex items-center justify-between">
          ...
          >
            <div className="w-10 h-10 bg-gradient-to-br from-primary to-spareparts rounded-xl flex items-center justify-center">
